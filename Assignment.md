# Interpersonal Skills :alien:	
	Emiliano Nazareno Rojas Marcelli
	ID: F11215120
...
> [!NOTE] 
> Study Notes based on the reference materials. Personal notes at the end of each section of the outline.
...
- Do not assume that the author is always correct.
- Critically reading involves asking appropriate questions. 
- Think about "critical questions." 

## Cretive Reading :nerd_face:	
- Its always easy to tear something down rather than to build it up.
- Read creatively involves harder effort, more positive thinking.
- Think about "creative questions."

## Make Notes :clipboard:	
- Make notes about questions or criticism.
- Underline key points.
-  Mark the important or questionable data.
	
## Summarize :file_folder:	
- Summarize the paper into one or two sentences.
- The summarization represent how much we have understood about the author's idea, questions or answers.
- Good summarize show the scientific contribution of the paper.

## Comparision with Related Works :recycle:	
- In order to find the scientific merit, it is necessary to make comparision with other works.
- It helps to determine which sort of contribution it is making
...
# How to Write a Report :pencil2:	
> [!TIP]
> The essence and nature of the different types of reports.  

## Essay
__An essay is a  writing of a specific topic.__
### Essay's structure: 
    1. Introduction
    2. Body
    3. Conclusion
...
__The idea is to present the main points from a work, which can be shown in a poster or slide presentation. Only key information should be shown.__
...
## Quizzes :100:	
__It is important to read the questions carefully as well as our answers.__ 
### Quizzes' Types:
	1. Multiple Choice
 	2. Fill in the Blancks
	3. Short/Extended Responses and others

## Reports
__A report is made for present a study, investigation, some analysis, proposals or findings.__
...
> [!NOTE] 
> The structure of the report can vary depending on the application. 

# 10 Tips for Better Teamwork :busts_in_silhouette:	
> [!TIP]
...
##  People are the joy and the problem in better teamwork :speaking_head:	
...
### Respectful Communication :hearts:	
...
### Strong Sense of Group Commitment :muscle:	
...
### Team Members are Uniques :raised_hands:	
...
### Creativity and Innovation :trollface:	
...
### Solving Problems and Conflicts :brain:	
...
### Participative Team :globe_with_meridians:	
...
### Makes High-Quality Decisions As a Team :handshake:	
...
# :five: Minutes Presentation  :hourglass_flowing_sand:	
> [!TIP]
> Tips to create an interesting and single message presentation in 5 minutes.   
  ...
  ## Engage to the main point :pinching_hand:	
