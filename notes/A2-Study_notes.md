...
![image](https://hackmd.io/_uploads/r1fk4qbeR.png)
...
![image](https://hackmd.io/_uploads/HywHzqZx0.png)

1. Connection between adhoc with it's client is not succed, even if the adhoc network is already broadcasting beacon

![image](https://hackmd.io/_uploads/Sy5Kfc-lC.png)

![image](https://hackmd.io/_uploads/HkXALqblR.png)
...
![image](https://hackmd.io/_uploads/S1sP49WeA.png)
...
![image](https://hackmd.io/_uploads/Hks_LqbgA.png)

2. Hidden node scenario. 

    a. RTS and CTS Sequence detected by wireshark

    ![image](https://hackmd.io/_uploads/BJmC4qbeR.png)
    ...
    ![image](https://hackmd.io/_uploads/HkJ3DcbxC.png)
